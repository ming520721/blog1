...
const blogConfig = {
	...
	scripts: [
		// Umami 统计
		{ src: 'https://cloud.umami.is/script.js', 'data-website-id': '800e3fe8-fda3-4c7e-a22a-f39715aa309f', defer: true },
		// Twikoo 评论系统
...
export const myFeed: FeedEntry = {
	...
	avatar: new URL(blogConfig.author.avatar, blogConfig.url).toString(),
	archs: ['Nuxt', 'Vercel'],
